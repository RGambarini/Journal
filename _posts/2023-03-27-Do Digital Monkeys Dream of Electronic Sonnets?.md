...
Keep in mind, we're not dealing with a random sequence of words with Shakespeare's writings. Sentences have a predefined structure that goes beyond simple grammatical rules. Sometimes you can predict a statement before it _____. <d-footnote>ends</d-footnote> The same could be said about the structure of words that is not dependent on the use of a dictionary like in our data analysis.
{: style="text-align: justify;"}

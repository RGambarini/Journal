...
{: style="text-align: justify;"}
 ...
 <div style="text-align: center;"><iframe width="560" height="315" src="assets/img/Infinity/animation.gif" | prepend: site.baseurl | prepend: site.url}}" alt="animation"></iframe></div>
